...
public class MainActivity extends AppCompatActivity {
    ...
    public void inputs(String input){
        ...
        String lighton = "light on";
        String lightof = "light of";
        String lightoff = "light off";
        String fanon = "fan on";
        String fanof = "fan of";
        ...
        if(input.equals(lighton))
        {
            light.setBackgroundResource(R.drawable.lighton);
        }
        else if(input.equals(lightof)|| input.equals(lightoff))
        {
            light.setBackgroundResource(R.drawable.lightof);
        }
        else if(input.equals(fanon))
        {
            fan.setBackgroundResource(R.drawable.fanon);
        }
        else if(input.equals(fanof)|| input.equals(fanoff))
        {
            fan.setBackgroundResource(R.drawable.fanoff);
        }
        else
        {
            Toast.makeText(MainActivity.this, "Your Voice input is Incorrect",
